<x-layout docTitle="Editing {{$post->title}}">
    <div class="container py-md-5 container--narrow">
        <p><small><strong>
            <a href="/post/{{$post->id}}">&laquo; Back to post permalink</a>
        </strong></small></p>
        ...
        <div class="form-group">
            ...
            <textarea required name="body" id="post-body" class="body-content tall-textarea form-control" type="text">{{old('title', $post->body)}}</textarea>
            @error('body')
                <p class="m-0 small alert alert-danger shadow-sm">
                    {{$message}}
                </p>
